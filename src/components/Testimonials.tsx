...
const testimonials = [
  ...
  },
  {
    ...
    color: 'bg-gradient-to-br from-teal-400 to-emerald-400',
  ...
  return (
    <section className="py-32 bg-gradient-to-b from-black to-zinc-900">
      <div className="container mx-auto px-4">
        {/* Section Title */}
        <h1 className="text-white text-7xl font-bold mb-24 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="group grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`${testimonial.color} rounded-3xl p-6 shadow-lg transition-all duration-700 ease-out backdrop-blur-sm
                  group-hover:translate-x-0 group-hover:translate-y-0 group-hover:rotate-0
                  ${testimonial.transform} hover:scale-105 hover:shadow-2xl`}
                style={{
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 relative rounded-full overflow-hidden ring-2 ring-white/20">
                    <Image
